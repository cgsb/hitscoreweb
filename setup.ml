...
(* OASIS_START *)
(* DO NOT EDIT (digest: 8ae5132503a69130242978c47e22b0bd) *)
(*
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Hitscore_web"; "Hitscore_web_std"];
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = "./src/app/";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "Hitscore_web"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
