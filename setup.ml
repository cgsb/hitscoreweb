...
(* OASIS_START *)
(* DO NOT EDIT (digest: 8dc175a27f0746b9bd2a56e82d57fbda) *)
(*
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = "src/simple_pam";
                      bs_compiled_object = Best;
                      bs_build_depends = [];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = ["simple_pam_stubs.c"];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      bs_cclib =
                        [(OASISExpr.EBool true, ["-lpam"; "-lresolv"])];
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("hitscoregen", None);
                           InternalLibrary "hitscorewebpam";
                      ...
                      },
                   {
                      lib_modules =
                        [
                           "Hitscoreweb";
                           "Hitscoreweb_queries";
                           "Hitscoreweb_services";
                           "Hitscoreweb_authentication";
                           "Hitscoreweb_template";
                           "Hitscoreweb_layout_service";
                           "Hitscoreweb_std"
                        ];
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
